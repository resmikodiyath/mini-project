...
Company Stage (Seed, Series B, Post-IPO, etc.)
...
Standardizing industry, country, and stage names

Date formatting and year extraction

Validation of numeric fields (layoffs, funding)

Creation of clean, analysis-ready data
...
KPI Cards: Total layoffs, affected companies, industries

Year-wise layoff trends

Industry-wise layoffs analysis

Country-wise impact visualization

Company stage vs layoffs
...
Certain countries and regions are more heavily impacted

Post-IPO and late-stage companies show high layoff volumes
